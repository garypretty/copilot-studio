...
> **Important:** This feature is currently experimental and is not intended for production use. Not all features are supported when this feature is enabled. Review the [unsupported features](#unsupported-features) before enabling.
...
4. Under **Orchestration**, find **Enhanced task completion** and toggle it to **On**.
5. A confirmation dialog appears, listing the features that are not yet supported when this mode is enabled. Review the list, then select **Confirm** to enable the feature.
